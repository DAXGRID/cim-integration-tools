...
namespace CIM.PhysicalNetworkModel
{
    ...
    public abstract partial class PowerSystemResource : IdentifiedObject
    {
        ...
        public Asset Asset(CimContext context)
        {
            if (Assets?.@ref != null)
            {
                var asset = context.GetObject<Asset>(Assets.@ref);
        ...
        public LocationExt GetLocation(CimContext context)
        {
            if (Location?.@ref != null)
            {
                var loc = context.GetObject<LocationExt>(Location.@ref);
                return loc;
            }
