...
namespace CIM.PhysicalNetworkModel
{
    ...
    public abstract partial class IdentifiedObject
    {
        ...
        public Substation Substation(CimContext context)
        {
            ...
            if (this is BayExt)
            {
                ...
                return bayExt.VoltageLevel.Get(context).GetSubstation(context, false);
            }
            ...
            if (this is ConductingEquipment)
            {
                ...
                return ce.GetSubstation(context, false);
            }
        ...
        /// </summary>
        public EquipmentContainer Parent(CimContext context)
        {
            if (this is Substation)
            {
                return (Substation)this;
